package br.com.catapan.salaobeleza.domain.pagamento;
...
public class Pagamento implements Serializable {
	...
	@NotNull
	@OneToOne
	@MapsId //dizendo pra jpa, apesar do relacionamento com o pedido tem que pegar o id do outro lado e usar aqui.
	...
	@Enumerated(EnumType.STRING)//texto do enum ao inves do codigo.
